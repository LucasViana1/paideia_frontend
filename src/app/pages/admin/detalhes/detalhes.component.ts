...
export class DetalhesComponent implements OnInit {
  ...
  detalhes(id: any) {
    this.service
      ...
      .subscribe(dados => {
        ...
        //   this.listagem.dados[i].arquivo = this._sanitizationService.bypassSecurityTrustScript(this.listagem.dados[i].arquivo)
        // }
        // console.log('this.listagem.dados.length')
        // console.log(this.listagem.dados.length);
      });
  }
  ...
  showPdf(tipo:any) {
    ...
    // const linkSource = this.listagem.dados[2].arquivo;
    let linkSource = '';
    let fileName = '';
    for(let i = 0; i < this.listagem.dados.length; i++){
